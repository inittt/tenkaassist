...
const translate = {
   ...
   "화속성": {en : "Fire Attr.", sc : "火属性", tc : "火屬性", jp: "火属性"},
   "수속성": {en : "Water Attr.", sc : "水属性", tc : "水屬性", jp: "水属性"},
   "풍속성": {en : "Wind Attr.", sc : "风属性", tc : "風屬性", jp: "風属性"},
   "광속성": {en : "Light Attr.", sc : "光属性", tc : "光屬性", jp: "光属性"},
   "암속성": {en : "Dark Attr.", sc : "暗属性", tc : "闇屬性", jp: "闇属性"},
   "딜러" : {en : "Attacker", sc : "攻击者", tc : "攻擊者", jp : "アタッカー"}, 
   "힐러" : {en : "Healer", sc : "治疗者", tc : "治療者", jp : "ヒーラー"}, 
