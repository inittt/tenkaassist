...
const translate = {
   ...
   "이동하시겠습니까?" : {en : "Go to page?", sc : "是否前往该页面?", tc : "是否前往該頁面?", jp : "ページへ移動しますか?"},
   ...
   "{0}와(과) {1}의 조합은 반격이 스스로에게 피해를 입히기 때문에 생존할 수 없습니다": {en: "{0} cannot survive when combined with {1} because counterattacks inflict damage on themselves", sc: "{0} 与 {1} 的组合无法存活：反击会对自身造成伤害", tc: "{0} 與 {1} 的組合無法存活：反擊會對自身造成傷害", jp: "{0} と {1} の組み合わせは、反撃が reflective/self-damage（自分自身にダメージを与える）のため生き残れません"},
   ...
   "딜러:데미지+": { en: "DPS: DMG+", sc: "输出: 伤害+", tc: "輸出: 傷害+", jp: "アタッカー: DMG+" },
   "힐러:전체 공격+": { en: "Healer: All ATK+", sc: "治疗: 全体攻击+", tc: "治療: 全體攻擊+", jp: "ヒーラー: 全体攻撃+" },
   "탱커:전체 공격+": { en: "Tank: All ATK+", sc: "坦克: 全体攻击+", tc: "坦克: 全體攻擊+", jp: "タンク: 全体攻撃+" },
   "서포터:전체 공격+": { en: "Support: All ATK+", sc: "辅助: 全体攻击+", tc: "輔助: 全體攻擊+", jp: "サポーター: 全体攻撃+" },
   "디스럽터:데미지+": { en: "Disruptor: DMG+", sc: "妨害: 伤害+", tc: "妨害: 傷害+", jp: "ディスラプター: DMG+" },

   "딜러:공격+": { en: "DPS: ATK+", sc: "输出: 攻击+", tc: "輸出: 攻擊+", jp: "アタッカー: 攻撃+" },
   "힐러:전체 회복+": { en: "Healer: All Heal+", sc: "治疗: 全体回复+", tc: "治療: 全體回復+", jp: "ヒーラー: 全体回復+" },
   "탱커:전체 데미지 감소+": { en: "Tank: All DMG Reduction+", sc: "坦克: 全体伤害减少+", tc: "坦克: 全體傷害減少+", jp: "タンク: 全体DMG軽減+" },
   "서포터:전체 데미지+": { en: "Support: All DMG+", sc: "辅助: 全体伤害+", tc: "輔助: 全體傷害+", jp: "サポーター: 全体DMG+" },
   "디스럽터:치유 감소+": { en: "Disruptor: Heal Reduction+", sc: "妨害: 治疗减少+", tc: "妨害: 治療減少+", jp: "ディスラプター: 治癒減少+" },

   "통용:공격+": { en: "General: ATK+", sc: "通用: 攻击+", tc: "通用: 攻擊+", jp: "汎用: 攻撃+" },
   "통용:최대HP+": { en: "General: Max HP+", sc: "通用: 最大HP+", tc: "通用: 最大HP+", jp: "汎用: 最大HP+" },

   "화속성:데미지+": { en: "Fire: DMG+", sc: "火属性: 伤害+", tc: "火屬性: 傷害+", jp: "火属性: DMG+" },
   "수속성:데미지+": { en: "Water: DMG+", sc: "水属性: 伤害+", tc: "水屬性: 傷害+", jp: "水属性: DMG+" },
   "풍속성:데미지+": { en: "Wind: DMG+", sc: "风属性: 伤害+", tc: "風屬性: 傷害+", jp: "風属性: DMG+" },
   "광속성:데미지+": { en: "Light: DMG+", sc: "光属性: 伤害+", tc: "光屬性: 傷害+", jp: "光属性: DMG+" },
   "암속성:데미지+": { en: "Dark: DMG+", sc: "暗属性: 伤害+", tc: "暗屬性: 傷害+", jp: "闇属性: DMG+" },

   "화속성:데미지 감소+": { en: "Fire: DMG Reduction+", sc: "火属性: 伤害减少+", tc: "火屬性: 傷害減少+", jp: "火属性: DMG軽減+" },
   "수속성:데미지 감소+": { en: "Water: DMG Reduction+", sc: "水属性: 伤害减少+", tc: "水屬性: 傷害減少+", jp: "水属性: DMG軽減+" },
   "풍속성:데미지 감소+": { en: "Wind: DMG Reduction+", sc: "风属性: 伤害减少+", tc: "風屬性: 傷害減少+", jp: "風属性: DMG軽減+" },
   "광속성:데미지 감소+": { en: "Light: DMG Reduction+", sc: "光属性: 伤害减少+", tc: "光屬性: 傷害減少+", jp: "光属性: DMG軽減+" },
   "암속성:데미지 감소+": { en: "Dark: DMG Reduction+", sc: "暗属性: 伤害减少+", tc: "暗屬性: 傷害減少+", jp: "闇属性: DMG軽減+" },

   "딜러:궁극기 추가 공격+": { en: "DPS: Ultimate Extra ATK+", sc: "输出: 终极技追加攻击+", tc: "輸出: 終極技追加攻擊+", jp: "アタッカー: 必殺技追撃+" },
   "힐러:전체 데미지+": { en: "Healer: All DMG+", sc: "治疗: 全体伤害+", tc: "治療: 全體傷害+", jp: "ヒーラー: 全体DMG+" },
   "서포터:일반 공격 추가 공격+": { en: "Support: Basic Extra ATK+", sc: "辅助: 普通攻击追加攻击+", tc: "輔助: 普通攻擊追加攻擊+", jp: "サポーター: 通常攻撃追撃+" },
   "디스럽터:궁극기+": { en: "Disruptor: Ultimate+", sc: "妨害: 终极技+", tc: "妨害: 終極技+", jp: "ディスラプター: 必殺技+" },

   "딜러:일반 공격 추가 공격+": { en: "DPS: Basic Extra ATK+", sc: "输出: 普通攻击追加攻击+", tc: "輸出: 普通攻擊追加攻擊+", jp: "アタッカー: 通常攻撃追撃+" },
   "힐러:치유+": { en: "Healer: Healing+", sc: "治疗: 治疗+", tc: "治療: 治療+", jp: "ヒーラー: 治癒+" },
   "탱커:전체 방어 데미지 감소+": { en: "Tank: All DEF DMG Reduction+", sc: "坦克: 全体防御伤害减少+", tc: "坦克: 全體防禦傷害減少+", jp: "タンク: 全体防御DMG軽減+" },
   "서포터:궁극기 추가 공격+": { en: "Support: Ultimate Extra ATK+", sc: "辅助: 终极技追加攻击+", tc: "輔助: 終極技追加攻擊+", jp: "サポーター: 必殺技追撃+" },
   "디스럽터:일반 공격+": { en: "Disruptor: Basic ATK+", sc: "妨害: 普通攻击+", tc: "妨害: 普通攻擊+", jp: "ディスラプター: 通常攻撃+" },

   "딜러:공격 트리거+": { en: "DPS: ATK Trigger+", sc: "输出: 攻击触发+", tc: "輸出: 攻擊觸發+", jp: "アタッカー: 攻撃トリガー+" },
   "힐러:지속 치유+": { en: "Healer: Continuous Heal+", sc: "治疗: 持续治疗+", tc: "治療: 持續治療+", jp: "ヒーラー: 継続治癒+" },
   "탱커:전체 아머+": { en: "Tank: All Armor+", sc: "坦克: 全体护甲+", tc: "坦克: 全體護甲+", jp: "タンク: 全体アーマー+" },
   "서포터:공격 트리거+": { en: "Support: ATK Trigger+", sc: "辅助: 攻击触发+", tc: "輔助: 攻擊觸發+", jp: "サポーター: 攻撃トリガー+" },
   "디스럽터:트리거+": { en: "Disruptor: Trigger+", sc: "妨害: 触发+", tc: "妨害: 觸發+", jp: "ディスラプター: トリガー+" },
   ...
   "탱커" : {en : "Protector", sc : "守护者", tc : "守護者", jp : "ガーディアン"}, 
   ...
   "작은체형" : {en : "Small Sized", sc : "小体型", tc : "小體型", jp : "小柄"}, 
   "표준체형" : {en : "Medium Sized", sc : "中体型", tc : "中體型", jp : "中肉中背"},
   "빈유" : {en : "Flat Tits", sc : "贫乳", tc : "貧乳", jp : "貧乳"}, 
   "미유" : {en : "Hot Tits", sc : "美乳", tc : "美乳", jp : "美乳"}, 
   "거유" : {en : "Giant Tits", sc : "巨乳", tc : "巨乳", jp : "巨乳"},
   ...
   "데미지" : {en : "Damage Output", sc : "输出", tc : "輸出", jp : "出力"}, 
   ...
   "전투" : {en : "More Power", sc : "越战越强", tc : "越戰越強", jp : "持続強化"}, 
   ...
   "청이블" : {en : "SS.Iblis", sc : "暑伊", tc : "暑伊", jp : "真夏の清涼 イブリース"},
   "수릴리" : {en : "S.Evie", sc : "夏鹿", tc : "夏鹿", jp : "夏の日 リリー"},
   "수놀라" : {en : "S.Noma", sc : "夏狂", tc : "夏犬", jp : "夏の日 ノルディ"},
   "포르네" : {en : "Forneusa", sc : "鯊魚", tc : "鲨鱼", jp : "フォルネ"},
   "성야네" : {en : "Bu.Ayane", sc : "觉勇", tc : "覺勇", jp : "聖剣解放 神田綾音"},
   "승나미" : {en : "Sky.Nanami", sc : "天美", tc : "空奈", jp : "パイロット 星空ななみ"},
   "기바알" : {en : "Sky.Baal", sc : "机巴", tc : "機巴", jp : "機長 バル"},
   "백루루" : {en : "N.Lulu", sc : "护露", tc : "護露", jp : "白衣の天使 ルル"},
   "유리" : {en : "Yuri", sc : "优璃", tc : "優璃", jp : "ユリ"},
   "갸브리" : {en : "G.Britney", sc : "水军", tc : "水軍", jp : "ギャル ブリトニー"},
   "여야네" : {en : "L.Ayane", sc : "悠勇", tc : "悠勇", jp : "のんびり 神田綾音"},
   ...
   "장이블" : {en : "5.Iblis", sc : "丧伊", tc : "喪伊", jp : "散った薔薇 イブリース"},
   "장사탄" : {en : "5.Satan", sc : "丧旦", tc : "喪撒", jp : "死寂の葬花 サタン"},
   "장바알" : {en : "5.Baal", sc : "丧巴", tc : "喪巴", jp : "枯れた薔薇 バル"},
   "마나나" : {en : "5.Nana", sc : "丧娜", tc : "喪娜", jp : "魔王 ナナ"},
   "신즈카" : {en : "B.Shizuka", sc : "花静", tc : "花靜", jp : "花嫁 静"},
   "신사기" : {en : "M.Usagihime", sc : "神兔", tc : "神兔", jp : "神の使者 兎姫"},
   "신이카" : {en : "B.Aiko", sc : "花艾", tc : "花艾", jp : "花嫁 アイカ"},
   "신란" : {en : "B.Lana", sc : "花矮", tc : "花矮", jp : "花嫁 ラン"},
   "신야네" : {en : "B.Ayane", sc : "花勇", tc : "花勇", jp : "花嫁 神田綾音"},
   "냉모모" : {en : "Cos.Momo", sc : "毛毛", tc : "毛毛", jp : "冷艶の刃 モモ"},
