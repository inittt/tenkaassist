...
document.addEventListener("DOMContentLoaded", function() {
   ...
   radios3.forEach(function(option) {
      option.addEventListener("click", function() {
         if (this.value == "none") dropdownBtn3.innerHtml = "none";
         else dropdownBtn3.innerHtml = getElIconText(this.value);
         const spanElement = document.createElement('span');
         spanElement.classList.add('absolute-right');
         spanElement.innerHTML = '▼'
...
function getElIconText(input) {
   if (input == "none") return "none";
   return `<img class="icon" src="../images/elements/${input}.png">`;
}
